public class CookieRecipe {
        ...
        public void printIngredients() {
            System.out.println("Koekje ingredienten");
            System.out.println("");
        ...
        public void printRecipeSteps() {
            System.out.println("Koekje Recept");
            System.out.println("");
        ...
        public void recipeStepOne(String nameStep) {
            System.out.println(nameStep + "Verwarm de oven van te voren op 170 graden Celsius om het koekje te bakken (boven en onderwarmte)");
        }
